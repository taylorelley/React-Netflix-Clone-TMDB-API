...
beforeEach(async () => {
  ...
  m.getMovieDetails.mockResolvedValue({ id: 550, title: 'Fight Club' });
  m.getMovieTrailer.mockResolvedValue('dQw4w9WgXcQ');
  ...
  m.searchMovies.mockResolvedValue([{ id: 1, title: 'Test Movie' }]);
});

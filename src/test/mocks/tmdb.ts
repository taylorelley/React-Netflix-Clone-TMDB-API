...
export const getMovieDetails: Mock<(id: number | string) => Promise<Movie>> = vi
  .fn()
...
export const getMovieTrailer: Mock<
  (id: number | string) => Promise<string | null>
> = vi.fn().mockResolvedValue('dQw4w9WgXcQ');

export const getMovieReviews: Mock<
  (id: number | string) => Promise<{ results: Review[]; total_results: number }>

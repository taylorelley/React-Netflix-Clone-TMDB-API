...
function MovieDetails() {
  ...
  const { movie } = useMovieDetails(movieid ?? null);
  const { trailerKey } = useMovieTrailer(movieid ?? null);
  const { reviews, totalReviews } = useMovieReviews(movieid ?? null);
    ...
    <div
      className={
        darkMode
          ...
          : 'movie-details-container details-light'
      }
    >
      {trailerKey ? (
        ...
        <div className="trailer-container-blank" style={blankStyle}>
      ...
      <div
        className={
          darkMode ? 'details-container' : 'details-container details-light'
        }
      >

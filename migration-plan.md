...
export const getUpcomingMovies = vi.fn().mockResolvedValue([
  { id: 2, title: 'Upcoming Movie', overview: 'Overview text', backdrop_path: '/y.jpg',
    genre_ids: [28], vote_average: 8, release_date: '2026-12-01' },
]);
export const getMovieDetails  = vi.fn().mockResolvedValue({
  id: 550, title: 'Fight Club', overview: '...', poster_path: '/z.jpg',
  vote_average: 8.4, genres: [{ id: 18, name: 'Drama' }], runtime: 139,
  budget: 63000000, tagline: 'Mischief. Mayhem. Soap.', status: 'Released',
});
